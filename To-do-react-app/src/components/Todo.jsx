...
function Todo(props) {
	...
	const viewTemplate = (
		<>
			...
			<div className="task-item-text">{props.name}</div>
			...
			<form onSubmit={handleSubmit}>
				...
				<button className="save-btn" type="submit">
					...
					>
						<path
							fill="currentColor"
							d="m10.925 13.8l4.963-4.938l-.713-.714l-4.25 4.25L8.8 10.273l-.708.708zm-9.156 5.662v-1h20.462v1zm1.231-2v-13h18v13zm1-1h16v-11H4zm0 0v-11z"
						/>
					</svg>
				</button>
